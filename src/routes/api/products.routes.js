...
import { getProducts, getProductById, saveProduct } from "../../services/productService.js";
...
productsRoutes.delete('/:pid', async (req, res)=>{
    ...
    const isOk = await saveProduct(filteredProdcts)
...
productsRoutes.post('/',uploader.array('file'), verifyProduct, async (req, res)=>{
    ...
    const isOk = await saveProduct(products)
...
productsRoutes.put('/:pid', verifyProduct, async (req, res)=>{
    ...
    const isOk = await saveProduct(updateProducts)
    if (!isOk) {
